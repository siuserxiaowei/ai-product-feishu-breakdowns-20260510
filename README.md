...
### English
Standalone GitHub Pages site for Shu-Fa-Dao-Qi-Shi breakdowns of three Feishu AI product notes from 2026-05-10.
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/ai-product-feishu-breakdowns-20260510
- Live / 在线入口：https://siuserxiaowei.github.io/ai-product-feishu-breakdowns-20260510/
- 默认分支 / Default branch: `main`
- 主要语言 / Primary language: `HTML`
- 可见性 / Visibility: `public`
- 仓库类型 / Repository type: `source`
- Topics / 主题：`ai`, `feishu`, `github-pages`, `knowledge-base`, `meeting-notes`, `static-site`
